...
export const CANTON_CONFIG = {
  ...
  VALIDATOR_ADMIN_API_URL: 'http://localhost:2903',
  VALIDATOR_ADMIN_API_PORT: 2903,
  ...
  // Token configuration
  TOKEN_DECIMALS: 2,
  TOKEN_INITIAL_SUPPLY: 1000000, // 10,000.00 tokens with 2 decimals
  
  // Network name from env
  NETWORK_NAME: 'Splice',
  AMULET_NAME: 'Amulet',
  AMULET_NAME_ACRONYM: 'AMT',
}
